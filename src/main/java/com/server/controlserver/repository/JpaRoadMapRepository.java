...
public class JpaRoadMapRepository implements RoadMapRepository{
    ...
    public Optional<RoadMap> findByRoadMapName(String roadMapName) {
        List<RoadMap> result = em.createQuery("select r from RoadMap r where r.roadMapName = :roadMapName", RoadMap.class)
    ...
    public List<RoadMap> findAll() {
        List<RoadMap> result = em.createQuery("select r from RoadMap r", RoadMap.class)
                .getResultList();
        return result;
    }
}
