...
public class UserController {
  ...
  public ResponseEntity<UserResponseDto> Login(@RequestBody LoginRequestDto loginRequestDto) {
    ...
    if (token != null) {
      ...
      //            return new ResponseEntity<>(httpHeaders, HttpStatus.OK); /* http state code
      // `200` 반환 */
  ...
  @ResponseBody
  public ResponseEntity<PetResponseDto> signup(
      PetRequestDto petRequestDto, @PathVariable String userId) {
